...
var buildingsStart = [enums.BUILDING_TYPE.ARCHERY, enums.BUILDING_TYPE.BLACKSMITH, enums.BUILDING_TYPE.TAVERN, enums.BUILDING_TYPE.ROAD, enums.BUILDING_TYPE.BOOTH_FISH, enums.BUILDING_TYPE.BOOTH_GEMS, enums.BUILDING_TYPE.BUTCHER]
