...
var buildingsStart = [enums.BUILDING_TYPE.ARCHERY, enums.BUILDING_TYPE.BLACKSMITH, enums.BUILDING_TYPE.TAVERN, enums.BUILDING_TYPE.BOOTH_PRODUCE, enums.BUILDING_TYPE.BOOTH_FISH, enums.BUILDING_TYPE.BOOTH_GEMS, enums.BUILDING_TYPE.BUTCHER, enums.BUILDING_TYPE.STABLES, enums.BUILDING_TYPE.TANNER, enums.BUILDING_TYPE.SCRIBE, enums.BUILDING_TYPE.CHAPEL]
